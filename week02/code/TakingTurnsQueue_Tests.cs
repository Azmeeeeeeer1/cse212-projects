...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns were removed from the queue instead
    // of being placed back into the queue as required for infinite turns.
    ...
    // Defect(s) Found: People with negative turns were removed from the queue
    // instead of being placed back into the queue as required for infinite turns.
